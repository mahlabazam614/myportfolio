...
import portimage from "../../public/imge.png";
import { ArrowDownTrayIcon } from "@heroicons/react/24/solid";
import { useState, useEffect } from "react";
import { FaMoon, FaSun } from "react-icons/fa";

const typingTexts = ["Frontend Web Developer", "Frontend Developer", "UI/UX Designer", "React Developer", "Next.js Developer", "Python Developer","flutter developer", "TypeScript Developer", "JavaScript Developer", "Web Developer", "Remote Worker"];
const nameText = "Mahlab Azam";
      ...
      <section className=" fonts flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-20 lg:px-32 h-[calc(100vh-100px)] relative z-10">
        ...
        <div className="z-20 mt-10 md:mt-0 text-center md:text-left max-w-xl animate-fadeInUp">
          ...
          <p className="mt-6 max-w-md text-base md:text-lg opacity-90 leading-relaxed">
           👋 Hi, I'm a passionate Frontend & Full Stack Developer skilled in building modern, user-focused web and mobile applications. I specialize in React, Next.js, TypeScript, and JavaScript, with a strong eye for UI/UX design. I also work with Python and Flutter to create seamless experiences across platforms. Always open to remote opportunities and collaborative projects. <strong>HTML | CSS | React | Next.js | Tailwind CSS | TypeScript | JavaScript | Python | flutter</strong>.
          </p>
